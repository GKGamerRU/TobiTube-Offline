...
namespace TobiTube_Offline.Pages
{
    public class SearchPage : Page
    {
        ...
        public SearchPage(VScrollBar scroll, PictureBox rect)
        {
        ...
        public override void Redraw(Graphics e, Point Target, bool Click)
        {
            ...
            e.DrawString(Title, new Font("Segoe UI", 18), new SolidBrush(ThemeSystem.CurrentTheme["TextColor"]), x, y);
            y += 36;
            y += 36;
            y += 36;
            List<Video> temp = DrawVideos(Result, e, Target, ref x, ref y, ref targeted, ref Click, Count);

            DrawControl(Target, NoFilter, e, 9 + SortNew.Scale.Width + SortOld.Scale.Width, 5 + 36 - MainPage_ScrollBar.Value, Click, ref targeted);
            DrawControl(Target, SortOld, e, 7 + SortNew.Scale.Width, 5 + 36 - MainPage_ScrollBar.Value, Click, ref targeted);
            DrawControl(Target, SortNew, e, 5, 5 + 36 - MainPage_ScrollBar.Value, Click, ref targeted);

            DrawControl(Target, SortLong, e, 5, 5 + 36 + 36 - MainPage_ScrollBar.Value, Click, ref targeted);
            DrawControl(Target, SortShort, e, 7 + SortLong.Scale.Width, 5 + 36 + 36 - MainPage_ScrollBar.Value, Click, ref targeted);
